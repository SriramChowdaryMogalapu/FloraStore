...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to <b>FLORA STORE</b>, Balancing Beauty and Wellness!</p>
      <p className="about-us-content">
        At Flora Store, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="plant_logo_left"><img
              src={logo}
              alt="E-Plant" width="50px" height="50px"/></p>
      <p className="about-us-content">
      ...
      <p className="plant_logo_right"><img
              src={logo}
              alt="E-Plant" width="50px" height="50px"/></p>

      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Harmony Gardens today and experience the 
